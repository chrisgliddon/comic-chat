...
// The Win32 resource API, REAL now: served from chat.rc's resources compiled into the binary
// (native/shim/rcdata.cpp, generated by native/gen-rcdata.py) - which is what rc.exe and the
// linker did for the original. See native/shim/resources.h. This is what makes the emotion
// wheel's face icons load.
