...
NATIVE_UNITS="avbdump posedump ojson oracleseed
              ...
              render cgblit cgdraw session asyncsocket msgmap uimaps resources cgsurface rcdata"
...
native_stage() {
    ...
    for c in glyphtable glyphtable_cdc stringtable cgblit cgdraw asyncsocket msgmap uimaps resources cgsurface rcdata; do
